...
export const fr: Dictionary = {
  ...
  properties: {
    ...
    fields: {
      ...
      marketValue: "Valeur de marché estimée (€)",
      marketValueHint: "Ce que vaut le bien aujourd'hui.",
      ...
      works: "Travaux (€)",
      worksHint: "Montant investi à l'achat pour améliorer le bien.",
      housingTax: "Taxe d'habitation (€/an)",
      propertyTax: "Taxe foncière (€/an)",
      insuranceMonthly: "Assurance (€/mois)",
      dpeClass: "Classe DPE",
    ...
    loans: {
      title: "Emprunts",
      defaultLabel: "Emprunt",
      add: "Ajouter un emprunt",
      edit: "Modifier",
      delete: "Supprimer",
      confirmDelete: "Supprimer cet emprunt ?",
      empty: "Aucun emprunt sur ce bien.",
      save: "Enregistrer l'emprunt",
      saving: "Enregistrement…",
      cancel: "Annuler",
      fields: {
        label: "Libellé (facultatif)",
        labelPlaceholder: "ex. Prêt principal",
      ...
      figures: {
        ...
        repaid: "{percent}% remboursé",
        term: "{months} mensualités",
      },
      summary: {
        monthlyTotal: "Total des mensualités",
        remainingTotal: "Capital restant total",
      },
      schedule: {
  ...
  tenants: {
    ...
    list: {
      tabs: {
        all: "Tous",
        active: "Bail actif",
        none: "Sans bail actif",
      },
      searchPlaceholder: "Rechercher un nom, un email ou un bien…",
      apply: "Filtrer",
      clear: "Réinitialiser",
      noMatch: "Aucun locataire ne correspond aux filtres.",
      company: "Société",
      hasAccount: "Compte activé",
      leaseNone: "Aucun",
      columns: {
        name: "Nom",
        contact: "Contact",
  ...
  leases: {
    ...
    list: {
      ...
      apply: "Filtrer",
      clear: "Réinitialiser",
      noMatch: "Aucun bail ne correspond aux filtres.",
    ...
    receipts: {
      ...
      generate: "Générer la quittance du mois",
      generated: "Quittance générée",
      empty: "Aucune quittance générée pour l'instant.",
      period: "Période",
      rent: "Loyer",
      charges: "Charges",
      total: "Total",
      ...
      delete: "Supprimer",
      confirmDelete:
        "Supprimer cette quittance et le PDF généré ? Cette action est irréversible.",
    },
    conditionReports: {
      title: "États des lieux",
      createMoveIn: "État des lieux d'entrée",
      createMoveOut: "État des lieux de sortie",
      empty: "Aucun état des lieux pour le moment.",
      moveIn: "Entrée",
      moveOut: "Sortie",
      date: "Date",
      ...
      delete: "Supprimer",
      confirmDelete:
        "Supprimer cet état des lieux (et son PDF généré, le cas échéant) ? Cette action est irréversible.",
      createdBanner:
        "Bail créé — vous pouvez préparer l'état des lieux d'entrée dès maintenant.",
      editor: {
        titleMoveIn: "État des lieux d'entrée",
        titleMoveOut: "État des lieux de sortie",
        backToLease: "Retour au bail",
        reportDate: "Date de l'état des lieux",
        metersTitle: "Relevés de compteurs",
        ...
        element: "Élément",
        condition: "État",
        entryCondition: "À l'entrée",
        comment: "Observations",
        conditionNone: "Non renseigné",
        conditions: {
          new: "Neuf",
          good: "Bon état",
          used: "État d'usage",
        ...
        photoUploadError: "Échec de l'envoi de la photo — réessayez.",
        notesTitle: "Observations générales",
        notesPlaceholder:
          "Tout élément utile (dégradations, accords, contexte)…",
        save: "Enregistrer le brouillon",
        saved: "Brouillon enregistré",
        saveError: "Échec de l'enregistrement — réessayez.",
        finalize: "Terminer et générer le PDF",
        confirmFinalize:
          "Terminer cet état des lieux ? Son contenu sera figé et le PDF enregistré dans Mes Documents.",
        finalized: "État des lieux terminé et enregistré dans Mes Documents",
        completedNotice:
          "Cet état des lieux est terminé et n'est plus modifiable.",
        reopen: "Repasser en brouillon",
        confirmReopen:
          "Repasser cet état des lieux en brouillon ? Le PDF généré sera supprimé.",
        noMoveIn:
          "Aucun état des lieux d'entrée terminé n'a été trouvé pour ce bail — la colonne de comparaison restera vide.",
      },
      defaults: {
        rooms: {
          entrance: "Entrée",
        ...
        furnitureElements: {
          bedding: "Literie (lit, couette ou couverture)",
          shutters: "Volets ou rideaux occultants dans les chambres",
          hobs: "Plaques de cuisson",
          oven: "Four ou four à micro-ondes",
          fridge: "Réfrigérateur et compartiment congélation",
          dishes: "Vaisselle",
          utensils: "Ustensiles de cuisine",
          tableSeats: "Table et sièges",
        ...
        elements: {
          ...
          ceiling: "Plafond",
          doors: "Portes",
          windows: "Fenêtres et volets",
          electrical: "Installations électriques",
          heating: "Chauffage",
          storage: "Rangements",
          plumbing: "Plomberie et sanitaires",
          appliances: "Électroménager",
        },
        keys: { entrance: "Clés d'entrée" },
      },
    },
  },
  myLease: {
